...
export const Home = (props) => {
  ...
  return (
      <>
      {
      imgSrc ?  <SaveEdit imgSrc={imgSrc} setAllertmsg={setAllertmsg} setOpen={setOpen} setImgSrc={setImgSrc} file={file} setFile={setFile}></SaveEdit>:
    <div className='homeContainer'>
        ...
        <Stack direction="column"
            ...
            <Typography sx={{color:'white'}} variant="subtitle2"   component="div">
            The memory of life
            </Typography>
        </Stack>
        <Stack
       ...
       <Button variant="contained" component="label">
        ...
        <Link to='/allimage'><Button  variant="contained">All Image</Button></Link>
        </Stack>
        </Box> 
    </div>
    }
